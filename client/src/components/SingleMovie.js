...
=======
            ...
            <div className="hidden-icon">
                <a href={"https://www.imdb.com/title/" + props.movie.imdbID} target="_blank">
                    <img src="https://i.pinimg.com/originals/e7/17/2e/e7172e01718bc174bc237b5971659548.png" alt="imdb-logo" />
                </a>
                <AnimatePresence mode="wait">
                    {
                        props.delSign === "login" ?
                            ...
                            : props.delSign ?
                                ...
                                <motion.img
                                    ...
                                    exit="hidden"
                                    key="plus"
                                    className="adddel" onClick={handleClick}
                                    src="https://www.clipartmax.com/png/full/43-433845_ambox-emblem-plus-green-plus-symbol.png"
                                    alt="add button" />
                    }
                </AnimatePresence>
